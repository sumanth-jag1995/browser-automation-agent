async def run(page, url: str, screenshot_dir: str) -> dict:
    """Automate flow: login_valid_credentials"""
    import os

    result = {"status": "success", "screenshots": [], "flow": "login_valid_credentials"}
    try:
        ...
        screenshot_path = os.path.join(screenshot_dir, "login_valid_credentials.png")
